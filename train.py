...
def train(model, training_data, validation_data, optimizer, device, opt):
    ...
    for epoch_i in range(opt.epoch):
        ...
        train_loss, train_accu = train_epoch(
            model, training_data, optimizer, device, smoothing=opt.label_smoothing, weight=weight)
        ...
        start = time.time()
        valid_loss, valid_accu = eval_epoch(model, validation_data, device, weight=weight)
